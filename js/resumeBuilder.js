...
var bio = {
    ...
    "skills": ["HTML", "CSS", "Bootstrap", "Javascript", "jQuery", "Python", "communication",
        "problem-solving", "team-work", "management", "planning & budgeting"
    ],
    "biopic": "images/me.jpg",
    /* 
     * This function uses the created objects to populate the DOM placeholder elements in helper.js & append them to index.html 
     * */
    "display": function() {
...
var projects = {
    ...
    "display": function() {
        for (var project = 0; project < projects.projectList.length; project++) {
            ...
            var formattedProjectTitle = HTMLprojectTitle.replace("%data%", projects.projectList[
                project].title);
            $(".project-entry:last").append(formattedProjectTitle);
            var formattedProjectDates = HTMLprojectDates.replace("%data%", projects.projectList[
                project].dates);
            $(".project-entry:last").append(formattedProjectDates);
            var formattedProjectDescr = HTMLprojectDescription.replace("%data%", projects.projectList[
                project].description);
            $(".project-entry:last").append(formattedProjectDescr);
            if (projects.projectList[project].images.length > 0) {
                for (var img = 0; img < projects.projectList[project].images.length; img++) {
                    var formattedprojectImage = HTMLprojectImage.replace("%data%", projects.projectList[
                        project].images[img]);
        ...
        for (var school = 0; school < education.schools.length; school++) {
            ...
            $(".education-entry:last").append(formattedSchoolLocation);
                if (education.schools[school].majors.length > 0) {
                    for (var item = 0; item < education.schools[school].majors.length; item++) {
...
$("#mapDiv").append(googleMap); //append the map to the resume